...
void display_table(){
    ...
    int k = 0;
    char* name[] = {"Fr","Cs","Rb","K","Na","Li","H","Ra","Ba","Sr","Ca","Mg","Be","Ac","La","Th","Ce","Pa","Pr","U","Nd","Np","Pm","Pu","Sm","Am","Eu","Cm","Gd","Bk","Tb","Cf","Dy","Es","Ho","Fm","Er","Md","Tm","No","Yb","Lr","Lu","Y","Sc","Rf","Hf","Zr","Ti","Db","Ta","Nb","V","Sg","W","Mo","Cr","Bh","Re","Tc","Mn","Hs","Os","Ru","Fe","Mt","Ir","Rh","Co","Ds","Pt","Pd","Ni","Rg","Au","Ag","Cu","Cn","Hg","Cd","Zn","Nh","Tl","In","Ga","Al","B","Fl","Pb","Sn","Ge","Si","C","Mc","Bi","SB","As","P","N","Lv","Po","Te","Se","S","O","Ts","At","I","Br","Cl","F","Og","Rn","Xe","Kr","Ar","Ne","He"};
    int col = 0;
    int L,C= 0;
    int shift = 0;
    for(int i = 0 ; i <32;i++){
